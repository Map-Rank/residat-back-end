                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                            ...
                            <button class="btn btn-primary" type="button">
                                <svg class="icon">
                                    <use xlink:href="{{ asset('assets/@coreui/icons/sprites/free.svg#cil-cloud-download')}}"></use>
                                </svg>
                            </button>
                        </div>
                    </div>
            ...
            <div class="row g-4 mb-4">
                    ...
                    <div class="card" style="--cui-card-cap-bg: #3b5998">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl text-white my-4">
                                <use xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-facebook-f')}}"></use>
                            </svg>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card" style="--cui-card-cap-bg: #00aced">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl text-white my-4">
                                <use xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-twitter')}}"></use>
                            </svg>
                            <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card" style="--cui-card-cap-bg: #4875b4">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl text-white my-4">
                                <use xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-linkedin')}}"></use>
                            </svg>
                            <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use xlink:href="{{ asset('assets/@coreui/icons/sprites/free.svg#cil-user')}}">
                                                </use>
                                            </svg>
                                            <div>Male</div>
                                    ...
                                    <div class="progress-group mb-5">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use
                                                    xlink:href="{{ asset('assets/@coreui/icons/sprites/free.svg#cil-user-female')}}">
                                                </use>
                                            </svg>
                                            <div>Female</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-google')}}">
                                                </use>
                                            </svg>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use
                                                    xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-facebook-f')}}">
                                                </use>
                                            </svg>
                                            <div>Facebook</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-twitter')}}">
                                                </use>
                                            </svg>
                                            <div>Twitter</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use
                                                    xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-linkedin')}}">
                                                </use>
                                            </svg>
                                            <div>LinkedIn</div>
                                ...
                                <table class="table border mb-0">
                                    <thead class="fw-semibold text-nowrap">
                                        <tr class="align-middle">
                                            <th class="bg-body-secondary text-center">
                                                <svg class="icon">
                                                    <use
                                                        xlink:href="{{ asset('assets/@coreui/icons/sprites/free.svg#cil-people')}}">
                                                    </use>
                                                </svg>
                                            </th>
                                    ...
                                    <tbody>
                                        <tr class="align-middle">
                                            <td class="text-center">
                                                <div class="avatar avatar-md"><img class="avatar-img"
                                                        src="{{ asset('assets/img/avatars/1.jpg')}}" alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use xlink:href="{{ asset('assets/@coreui/icons/sprites/flag.svg#cif-us')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-cc-mastercard')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-center">
                                                <div class="avatar avatar-md"><img class="avatar-img"
                                                        src="{{ asset('assets/img/avatars/2.jpg')}}" alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use xlink:href="{{ asset('assets/@coreui/icons/sprites/flag.svg#cif-br')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-cc-visa')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-center">
                                                <div class="avatar avatar-md"><img class="avatar-img"
                                                        src="{{ asset('assets/img/avatars/3.jpg')}}" alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use xlink:href="{{ asset('assets/@coreui/icons/sprites/flag.svg#cif-in')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-cc-stripe')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-center">
                                                <div class="avatar avatar-md"><img class="avatar-img"
                                                        src="{{ asset('assets/img/avatars/4.jpg')}}" alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use xlink:href="{{ asset('assets/@coreui/icons/sprites/flag.svg#cif-fr')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-cc-paypal')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-center">
                                                <div class="avatar avatar-md"><img class="avatar-img"
                                                        src="{{ asset('assets/img/avatars/5.jpg')}}" alt="user@email.com"><span
                                                        class="avatar-status bg-success"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use xlink:href="{{ asset('assets/@coreui/icons/sprites/flag.svg#cif-es')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-cc-apple-pay')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-center">
                                                <div class="avatar avatar-md"><img class="avatar-img"
                                                        src="{{ asset('assets/img/avatars/6.jpg')}}" alt="user@email.com"><span
                                                        class="avatar-status bg-danger"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use xlink:href="{{ asset('assets/@coreui/icons/sprites/flag.svg#cif-pl')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/@coreui/icons/sprites/brand.svg#cib-cc-amex')}}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
