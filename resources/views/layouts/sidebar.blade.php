<div class="sidebar-header border-bottom">
    <div class="sidebar-brand">
        <img class="img-fluid" width="88" height="32" src="{{ secure_asset('assets/brand/logo.jpg') }}" alt="LOGO" srcset="">
    </div>
...
<ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
    <li class="nav-item"><a class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}">
            <svg class="nav-icon">
                <use xlink:href="{{ secure_asset('assets/@coreui/icons/sprites/free.svg#cil-speedometer') }}"></use>
            </svg> Dashboard</a>
    </li>
    ...
    <li class="nav-item"><a class="nav-link {{ request()->routeIs('permissions.index') ? 'active' : '' }}" href="{{ route('permissions.index') }}">
        <svg class="nav-icon">
            <use xlink:href="{{ secure_asset('assets/@coreui/icons/sprites/free.svg#cil-beach-access') }}"></use>
        </svg>Roles </a>
    </li>
