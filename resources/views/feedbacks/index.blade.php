...
@section('content')
        ...
        <div class="container px-4">
            <div class="row mb-3">
                <div class="col-md-12 d-flex justify-content-between align-items-center">
                    <h1 class="my-0">List of feedbacks</h1>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td class="">
                                            <div class="text-nowrap">
                                                <a href="{{ $feedback->page_link }}" target="_blank" rel="noopener noreferrer">{{ $feedback->page_link }}</a>
                                            </div>
                                        </td>
                                        <td class="">
                                            <div class="text-nowrap">{{ $feedback->rating }}</div>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <button type="button" class="dropdown-item" data-coreui-toggle="modal" data-coreui-target="#viewModal-{{ $feedback->id }}" data-coreui-whatever="@getbootstrap">View</button>
                                                    <button type="button" class="dropdown-item text-danger" data-coreui-toggle="modal" data-coreui-target="#deleteModal-{{ $feedback->id }}" data-coreui-whatever="@getbootstrap">Delete</button>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            @foreach ($feedbacks->getUrlRange(1, $feedbacks->lastPage()) as $page => $url)
                                <li class="page-item {{ $page == $feedbacks->currentPage() ? 'active' : '' }}"><a class="page-link" href="{{ $url }}">{{ $page }}</a></li>
                            @endforeach
    ...
    @foreach ($feedbacks as $feedback)
        <div class="modal fade" id="deleteModal-{{$feedback->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- Modal View feedback -->
    @foreach ($feedbacks as $feedback)
        <div class="modal fade" id="viewModal-{{$feedback->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
